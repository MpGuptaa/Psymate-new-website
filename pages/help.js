					...
					<div className='container'>
						<div className='row align-items-center'>
							<div className='col-lg-5 mb-40'>
									...
									<div className='col-lg-12'>
										<div className='box-notify-me mt-15'>
											<div className='inner-notify-me'>
												...
												/>
												<button className='btn btn-brand-1 font-md'>
													Search
													<svg
								...
								<div className='mt-10'>
									<Link className='btn btn-tag-circle mr-10 mb-10' href='#'>
										guest users
									</Link>
									<Link className='btn btn-tag-circle mr-10 mb-10' href='#'>
										create account
									...
									<Link className='btn btn-tag-circle mb-10' href='#'>
										security
									</Link>
								</div>
							</div>
							<div className='col-lg-7 mb-40 d-none d-md-block'>
								<div className='box-banner-help'>
									<div className='box-cruelty shape-1'>
										<img
											src='assets/imgs/page/help/cruelty.png'
											alt='psymate'
										/>
									</div>
									<div className='banner-img-1'>
										<img
											src='assets/imgs/page/help/banner1.png'
											alt='psymate'
										/>
									</div>
									<div className='banner-img-2'>
										<img
											src='assets/imgs/page/help/banner2.png'
											alt='psymate'
										/>
									</div>
								</div>
										...
										<tr>
											<td>
												<div className='item-forum'>
													...
													<div className='item-info'>
														...
														<p className='font-md color-grey-500'>
															Seamless importing and round-tripping of
															Microsoft Project plans, Excel files
															&amp; CSV files.
														</p>
													</div>
												</div>
											...
											<td>
												<div className='box-author'>
													<span>
														<img
															src='assets/imgs/page/help/author.png'
															alt='psymate'
														/>
													</span>
													<div className='author-info'>
														<span className='font-lg color-brand-1 author-name'>
															Steven Job
														</span>
										...
										<tr>
											...
											<td>
												<div className='box-author'>
													<span>
														<img
															src='assets/imgs/page/help/author2.png'
															alt='psymate'
														/>
													</span>
													<div className='author-info'>
										...
										<tr>
											...
											<td>
												<div className='box-author'>
													<span>
														<img
															src='assets/imgs/page/help/author3.png'
															alt='psymate'
														/>
													</span>
													<div className='author-info'>
										...
										<tr>
											...
											<td>
												<div className='box-author'>
													<span>
														<img
															src='assets/imgs/page/help/author4.png'
															alt='psymate'
														/>
													</span>
													<div className='author-info'>
										...
										<tr>
											...
											<td>
												<div className='box-author'>
													<span>
														<img
															src='assets/imgs/page/help/author5.png'
															alt='psymate'
														/>
													</span>
													<div className='author-info'>
										...
										<tr>
											...
											<td>
												<div className='box-author'>
													<span>
														<img
															src='assets/imgs/page/help/author6.png'
															alt='psymate'
														/>
													</span>
													<div className='author-info'>
										...
										<tr>
											...
											<td>
												<div className='box-author'>
													<span>
														<img
															src='assets/imgs/page/help/author7.png'
															alt='psymate'
														/>
													</span>
													<div className='author-info'>
						...
						<div className='box-radius-border box-radius-border-help'>
							<div className='row align-items-center'>
								<div className='col-xl-6 col-lg-6'>
									<img
										className='d-block'
										src='assets/imgs/page/help/answer.png'
										alt='psymate'
									/>
								</div>
								<div className='col-xl-6 col-lg-6'>
									<div className='box-info-answer'>
										<span className='btn btn-tag'>More help</span>
