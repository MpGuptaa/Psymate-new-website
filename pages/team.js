							...
							<div className='row align-items-center'>
								<div className='col-lg-5'>
									<h2 className='color-brand-1 mb-20'>
										Customers Love Our Creative Team, and So Will You
									</h2>
									...
									<p className='font-md color-grey-500 mb-25'>
										“Highly recommend Psymate Agency! They guide us on marketing
										initiatives and develop great strategies to increase our
										return on investment. The agency is excellent at being
										cooperative and responding quickly.”
									</p>
									<div className='box-author'>
										<Link href='#'>
											<img
												src='assets/imgs/page/team/author.png'
												alt='psymate'
											/>
										</Link>
									...
									<div className='box-banner-team'>
										...
										<div className='banner-col-1'>
											<div className='img-banner'>
												<img
													src='assets/imgs/page/team/banner1.png'
													alt='psymate'
												/>
											</div>
										</div>
										<div className='banner-col-2'>
											<div className='img-banner'>
												{' '}
												<img
													src='assets/imgs/page/team/banner2.png'
													alt='psymate'
												/>
											</div>
											<div className='img-banner hasBorder'>
												{' '}
												<img
													src='assets/imgs/page/team/banner3.png'
													alt='psymate'
												/>
											</div>
										</div>
										<div className='banner-col-3'>
											<div className='img-banner hasBorder2'>
												{' '}
												<img
													src='assets/imgs/page/team/banner4.png'
													alt='psymate'
												/>
											</div>
											<div className='img-banner'>
												{' '}
												<img
													src='assets/imgs/page/team/banner5.png'
													alt='psymate'
												/>
											</div>
											<div className='img-banner'>
												{' '}
												<img
													src='assets/imgs/page/team/banner6.png'
													alt='psymate'
												/>
											</div>
										</div>
				...
				<div className='section bg-grey-80 pt-70 pb-70'>
					<div className='container'>
						<ul className='list-partners'>
							<li>
								<img src='assets/imgs/page/homepage1/placed.png' alt='psymate' />
							</li>
							<li>
								<img src='assets/imgs/page/homepage1/cuebiq.png' alt='psymate' />
							</li>
							<li>
								<img src='assets/imgs/page/homepage1/factual.png' alt='psymate' />
							</li>
							<li>
								<img src='assets/imgs/page/homepage1/placeiq.png' alt='psymate' />
							</li>
							<li>
								<img src='assets/imgs/page/homepage1/airmeet.png' alt='psymate' />
							</li>
							<li>
								<img src='assets/imgs/page/homepage1/spen.png' alt='psymate' />
							</li>
							<li>
								<img src='assets/imgs/page/homepage1/klippa.png' alt='psymate' />
							</li>
							<li>
								<img src='assets/imgs/page/homepage1/matrix.png' alt='psymate' />
							</li>
						</ul>
					</div>
				</div>
						...
						<div className='row align-items-start'>
							<div className='col-lg-6'>
								...
								<h2 className='color-brand-1 mb-50'>
									Meet the amazing team behind Psymate
								</h2>
							</div>
						</div>
						<div className='row align-items-start'>
							<div className='col-lg-3 col-md-6 col-sm-6'>
								<div className='card-team mb-30'>
									<div className='card-image'>
										<img src='assets/imgs/page/about/team1.png' alt='psymate' />
									</div>
							...
							<div className='col-lg-3 col-md-6 col-sm-6'>
								<div className='card-team mb-30'>
									<div className='card-image'>
										<img src='assets/imgs/page/about/team2.png' alt='psymate' />
									</div>
									<div className='card-info'>
										<Link className='font-lg' href='#'>
											Jennie Tho
							...
							<div className='col-lg-3 col-md-6 col-sm-6'>
								<div className='card-team mb-30'>
									<div className='card-image'>
										<img src='assets/imgs/page/about/team3.png' alt='psymate' />
									</div>
									<div className='card-info'>
										<Link className='font-lg' href='#'>
											Symon Lesin
										...
										<p className='font-xs color-grey-400'>
											...
											or corporate clientsorder a publication to publish news.
							...
							<div className='col-lg-3 col-md-6 col-sm-6'>
								<div className='card-team mb-30'>
									<div className='card-image'>
										<img src='assets/imgs/page/team/team1.png' alt='psymate' />
									</div>
									<div className='card-info'>
										<Link className='font-lg' href='#'>
											Virginia Aguilar
							...
							<div className='col-xl-3 col-lg-4 col-md-6 col-sm-6'>
								<div className='card-member'>
									<div className='card-top'>
										<div className='card-image'>
											<img
												src='assets/imgs/page/team/member1.png'
												alt='psymate'
											/>
										</div>
										<div className='card-info'>
									...
									<div className='card-bottom'>
										<p className='font-xs color-grey-500'>
											Joined since 2012, when we were just established. He is
											a great companion.
										</p>
									</div>
								</div>
							...
							<div className='col-xl-3 col-lg-4 col-md-6 col-sm-6'>
								<div className='card-member'>
									<div className='card-top'>
										<div className='card-image'>
											<img
												src='assets/imgs/page/team/member2.png'
												alt='psymate'
											/>
										</div>
										<div className='card-info'>
							...
							<div className='col-xl-3 col-lg-4 col-md-6 col-sm-6'>
								<div className='card-member'>
									<div className='card-top'>
										<div className='card-image'>
											<img
												src='assets/imgs/page/team/member3.png'
												alt='psymate'
											/>
										</div>
										<div className='card-info'>
							...
							<div className='col-xl-3 col-lg-4 col-md-6 col-sm-6'>
								<div className='card-member'>
									<div className='card-top'>
										<div className='card-image'>
											<img
												src='assets/imgs/page/team/member4.png'
												alt='psymate'
											/>
										</div>
										<div className='card-info'>
							...
							<div className='col-xl-3 col-lg-4 col-md-6 col-sm-6'>
								<div className='card-member'>
									<div className='card-top'>
										<div className='card-image'>
											<img
												src='assets/imgs/page/team/member5.png'
												alt='psymate'
											/>
										</div>
										<div className='card-info'>
							...
							<div className='col-xl-3 col-lg-4 col-md-6 col-sm-6'>
								<div className='card-member'>
									<div className='card-top'>
										<div className='card-image'>
											<img
												src='assets/imgs/page/team/member6.png'
												alt='psymate'
											/>
										</div>
										<div className='card-info'>
							...
							<div className='col-xl-3 col-lg-4 col-md-6 col-sm-6'>
								<div className='card-member'>
									<div className='card-top'>
										<div className='card-image'>
											<img
												src='assets/imgs/page/team/member7.png'
												alt='psymate'
											/>
										</div>
										<div className='card-info'>
							...
							<div className='col-xl-3 col-lg-4 col-md-6 col-sm-6'>
								<div className='card-member'>
									<div className='card-top'>
										<div className='card-image'>
											<img
												src='assets/imgs/page/team/member8.png'
												alt='psymate'
											/>
										</div>
										<div className='card-info'>
							...
							<div className='col-xl-3 col-lg-4 col-md-6 col-sm-6'>
								<div className='card-member'>
									<div className='card-top'>
										<div className='card-image'>
											<img
												src='assets/imgs/page/team/member9.png'
												alt='psymate'
											/>
										</div>
										<div className='card-info'>
							...
							<div className='col-xl-3 col-lg-4 col-md-6 col-sm-6'>
								<div className='card-member'>
									<div className='card-top'>
										<div className='card-image'>
											<img
												src='assets/imgs/page/team/member10.png'
												alt='psymate'
											/>
										</div>
										<div className='card-info'>
							...
							<div className='col-xl-3 col-lg-4 col-md-6 col-sm-6'>
								<div className='card-member'>
									<div className='card-top'>
										<div className='card-image'>
											<img
												src='assets/imgs/page/team/member11.png'
												alt='psymate'
											/>
										</div>
										<div className='card-info'>
							...
							<div className='col-xl-3 col-lg-4 col-md-6 col-sm-6'>
								<div className='card-member'>
									<div className='card-top'>
										<div className='card-image'>
											<img
												src='assets/imgs/page/team/member12.png'
												alt='psymate'
											/>
										</div>
										<div className='card-info'>
							...
							<div className='col-xl-7 col-lg-12'>
								<div className='box-video-business box-images-team'>
									<div className='item-video'>
										<img
											src='assets/imgs/page/team/question1.png'
											alt='psymate'
										/>
									</div>
									<div className='box-image-right'>
										<img
											className='mb-20'
											src='assets/imgs/page/team/question2.png'
											alt='psymate'
										/>
										<img
											src='assets/imgs/page/team/question3.png'
											alt='psymate'
										/>
									</div>
								</div>
							...
							<div className='col-lg-4 mb-70'>
								<div className='box-core-value pl-0'>
									...
									<div className='mt-30'>
										{' '}
										<Link
											className='btn btn-white-circle font-sm-bold border-brand'
											href='#'>
											JOIN OUR TEAM TODAY
										</Link>
									</div>
							...
							<div className='col-lg-4'>
								<ul className='list-core-value list-core-value-white'>
									<li>
										...
										<div className='box-border-dashed'>
											<p className='font-md color-grey-500 mb-20'>
												...
												make every decision and measure every outcome based
									...
									<li>
										...
										<div className='box-border-dashed'>
											<p className='font-md color-grey-500 mb-20'>
												We’re honest, transparent and committed to doing
												what’s best for our customers and our company. We
												openly collaborate in pursuit of the truth. We have
												no tolerance for politics, hidden agendas or
									...
									<li>
										...
										<div className='box-border-dashed'>
											<p className='font-md color-grey-500 mb-20'>
												...
												settle. We challenge our ideas of what’s possible in
												order to better meet the needs of our customers.
											</p>
										</div>
									</li>
									<li>
										...
										<div className='box-border-dashed'>
											<p className='font-md color-grey-500 mb-20'>
												Integrity is the foundation for everything we do. We
												are admired and respected for our commitment to
