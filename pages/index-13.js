...
const HomePage1 = () => {
	...
	return (
		<>
			<Head>
				<title>psymate - Multipurpose Startup & SaaS Template1</title>
			</Head>
									...
									<div className='row'>
										<div className='col-lg-9'>
											<p className='font-md color-grey-500 mb-30'>
												Optimize write performance with a document data
												model that maps to your application’s access
												patterns. Meet a wide range of query requirements
												via a single query API that supports everything from
												simple lookups to complex processing pipelines for
						...
						<div className='row mt-50'>
							...
							<div className='col-lg-4 col-md-6 col-sm-6'>
								<div className='card-offer hover-up'>
									<div className='card-image'>
										<img
											src='assets/imgs/page/homepage1/cross3.png'
											alt='psymate'
										/>
									</div>
									<div className='card-info'>
					...
					<div className='container'>
						<div className='text-center mb-70'>
							<h2 className='color-brand-1 mb-20'>
								High quality projects finished and awarded{' '}
								<br className='d-none d-xl-block' />
								on conferences around the globe.
							</h2>
						</div>
						<div className='row mt-50 mb-100'>
									...
									<div className='card-info'>
										<Link href='blog-detail'>
											<h4 className='color-brand-1'>
												The smart way to grow your money while you sleep
											</h4>
										</Link>
										<div className='mt-20'>
										...
										<p className='font-sm color-grey-500 mt-20'>
											...
											nec risus. Fusce varius vel velit commodo consectetur.
											Aliquam sodales posuere neque, eget placerat libero
											fermentum nec. Fusce malesuada laoreet enim, ut
											convallis odio eleifend vitae.
										</p>
											...
											<div className='card-info'>
												<Link href='blog-detail'>
													<h5 className='color-brand-1'>
														How to make a great impression from the
														first moment
													</h5>
												</Link>
												<div className='mt-10'>
									...
									<li>
										<div className='card-blog-list hover-up'>
											<div className='card-info'>
												<Link href='blog-detail'>
													<h5 className='color-brand-1'>
														How To Blow Through Capital At An Incredible
														Rate
													</h5>
												</Link>
												<div className='mt-10'>
