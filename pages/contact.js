							...
							<div className='row align-items-center'>
									...
									<div className='row'>
										<div className='col-lg-9'>
											<p className='font-md color-grey-500'>
												Request a demo, ask a question, or get in touch here. If you’re interested
												in working at Psymate Coporation, check out our
								...
								<div className='col-lg-5 d-none d-lg-block'>
									<div className='box-banner-contact'>
										<img src='assets/imgs/page/contact/banner.png' alt='psymate' />
									</div>
								</div>
							</div>
						</div>
						...
						<div className='row'>
								...
								<div className='card-small card-small-2'>
									<div className='card-image'>
										<div className='box-image'>
											<img src='assets/imgs/page/contact/headphone.png' alt='psymate' />
										</div>
									</div>
									<div className='card-info'>
										...
										<p className='font-xs color-grey-500'>
											Email{' '}
											<a className='color-success' href='mailto:support@Psymatetech.com'>
												support@Psymatetech.com{' '}
											</a>
											<br />
											For help with a current product or service or refer to FAQs and developer
											tools
										</p>
									</div>
								</div>
							...
							<div className='col-lg-3 col-md-6 col-sm-6'>
								<div className='card-small card-small-2'>
									<div className='card-image'>
										<div className='box-image'>
											<img src='assets/imgs/page/contact/phone.png' alt='psymate' />
										</div>
									</div>
									<div className='card-info'>
							...
							<div className='col-lg-3 col-md-6 col-sm-6'>
								<div className='card-small card-small-2'>
									<div className='card-image'>
										<div className='box-image'>
											<img src='assets/imgs/page/contact/chart.png' alt='psymate' />
										</div>
									</div>
									<div className='card-info'>
							...
							<div className='col-lg-3 col-md-6 col-sm-6'>
								<div className='card-small card-small-2'>
									<div className='card-image'>
										<div className='box-image'>
											<img src='assets/imgs/page/contact/earth.png' alt='psymate' />
										</div>
									</div>
									<div className='card-info'>
							...
							<div className='col-lg-5'>
								...
								<div className='mt-50'>
									<div className='card-offer card-we-do card-contact hover-up'>
										<div className='card-image'>
											<img src='assets/imgs/page/contact/img1.png' alt='psymate' />
										</div>
										<div className='card-info'>
											<h6 className='color-brand-1 mb-10'>Visit the Knowledge Base</h6>
											<p className='font-md color-grey-500 mb-5'>
												Browse customer support articles and step-by-step instructions for specific
												features.
											</p>
										</div>
									</div>
									<div className='card-offer card-we-do card-contact hover-up'>
										<div className='card-image'>
											<img src='assets/imgs/page/contact/img2.png' alt='psymate' />
										</div>
										<div className='card-info'>
											<h6 className='color-brand-1 mb-10'>Watch Product Videos</h6>
											<p className='font-md color-grey-500 mb-5'>
												Watch our video tutorials for visual walkthroughs on how to use our
												features.
											</p>
										</div>
									</div>
									<div className='card-offer card-we-do card-contact hover-up'>
										<div className='card-image'>
											<img src='assets/imgs/page/contact/img3.png' alt='psymate' />
										</div>
										<div className='card-info'>
									...
									<div className='row'>
										...
										<div className='col-xl-4 col-lg-5 col-md-5 col-sm-6 col-9'>
											<div className='form-group'>
												<button className='btn btn-brand-1-full font-sm' type='submit'>
													Send message
													<svg
														className='w-6 h-6 icon-16 ml-5'
														fill='none'
