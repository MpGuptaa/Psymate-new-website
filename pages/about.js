				...
				<section className='section pt-90 banner-about'>
					<div className='container text-center'>
						...
						<h2 className='color-brand-1 mb-15'>
							We are a digital agency that tackles{' '}
							<br className='d-none d-lg-block' />
							all your online challenges.
						</h2>
						<p className='font-md color-grey-400 mb-30'>
							Social media networks are open to all. Social media is typically used
							for social interation and <br className='d-none d-lg-block' />
							access to news and information, and decison making.
						</p>
					...
					<div className='container'>
						<div className='row'>
							<div className='col-lg-6'>
								<div className='item-core mb-30'>
									<div className='item-image'>
										<img src='assets/imgs/page/about/img1.png' alt='psymate' />
									</div>
									<div className='item-desc'>
										<p className='font-md color-grey-400 mb-15'>
											“Whether you are working from home, at the office or at
											the job site, we provide flexible tools so you can
											connect and collaborate on waterfall projects, agile
							...
							<div className='col-lg-6'>
								<div className='item-core mb-30'>
									<div className='item-image'>
										<img src='assets/imgs/page/about/img2.png' alt='psymate' />
									</div>
									<div className='item-desc'>
										<p className='font-md color-grey-400 mb-15'>
											“We created a revolutionary online knowledge and
											competencies assessment solution. It empowers thousands
											of organizations worldwide to grow by allowing them to
											get a broader picture and draw better conclusions”
										</p>
										<h6 className='color-brand-1'>Ralph Edwards</h6>
										<span className='color-grey-500 font-xs'>
											Chairman of the board
								...
								<div className='col-xl-6 col-lg-6 col-md-6'>
									<div className='box-info-video mt-30 mb-30'>
										...
										<h3 className='color-brand-1 mt-10 mb-15'>
											Behind every brand is an{' '}
											<br className='d-none d-lg-block' />
											interesting story
										</h3>
										<p className='font-md color-grey-400'>
											Ea nostrum temporibus ex nulla totam qui galisum quae a
											adipisci modi. In exercitationem culpa sed blanditiis
											corrupti sit doloremque maxime eos iusto molestiae ex
											laborum nulla in quas dignissimos 33 dolorum quis.
										</p>
							...
							<div className='row align-items-center'>
								<div className='col-xl-6 col-lg-6 col-md-6'>
									<div className='box-info-video mt-30 mb-30'>
										...
										<h3 className='color-brand-1 mt-10 mb-15'>
											We have a mission to help businesses grow the best with
											existing conditions
										</h3>
										<p className='font-md color-grey-400'>
											Ea nostrum temporibus ex nulla totam qui galisum quae a
											adipisci modi. In exercitationem culpa sed blanditiis
											corrupti sit doloremque maxime eos iusto molestiae ex
											laborum nulla in quas dignissimos 33 dolorum quis. Est
											dolor autem et voluptate autem id enim optio vel
											incidunt alias.
										</p>
									</div>
								</div>
