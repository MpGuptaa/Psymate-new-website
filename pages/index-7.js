									...
									<div className='box-banner-left-home7'>
										...
										<div className='row'>
											<div className='col-lg-10'>
												<p className='font-md color-grey-500 mb-25'>
													Collaborate, plan projects and manage resources
													with powerful features that your whole team can
													use. The latest news, tips and advice to help
													you run your business with less fuss.
												</p>
											</div>
										</div>
										...
										<div className='box-joined'>
											...
											<span className='join-thousands font-sm color-grey-400 d-inline-block'>
												...
												<Link
													className='font-sm-bold color-brand-1'
													href='#'>
													psymate platform!
												</Link>
											</span>
					...
					<div className='container'>
						<div className='row mt-50 align-items-end'>
							<div className='col-xl-4 col-lg-4 mb-30'>
								<h4 className='color-brand-1 mb-5'>
								...
								<div className='card-radius-32'>
									<div className='card-info'>
										...
										<p className='font-md color-grey-500 mb-20'>
											Track, manage, and control your expenses. The only
											financial management tool you’ll ever need.
										</p>
									...
									<div className='card-image'>
										{' '}
										<img
											src='/assets/imgs/page/homepage7/img-financial.png'
											alt='psymate'
										/>
									</div>
								</div>
							...
							<div className='col-xl-6 col-lg-6 mb-30'>
								<div className='card-radius-32 bg-4'>
									...
									<div className='card-image'>
										{' '}
										<img
											src='/assets/imgs/page/homepage7/automated.png'
											alt='psymate'
										/>
									</div>
								</div>
										...
										<div className='col-lg-6'>
											<div className='box-cover-pd'>
												<div className='box-image-rd-30'>
													...
													<img
														className='w-100'
														src='/assets/imgs/page/homepage7/img.png'
														alt='psymate'
													/>
												...
												<div className='item-number hover-up'>
													...
													<div className='info-num'>
														...
														<p className='font-md color-grey-500'>
															What makes us different from others? We
															give holistic solutions with strategy,
															design &amp; technology.
														</p>
													</div>
												</div>
					...
					<div className='container'>
						<div className='row align-items-center'>
							...
							<div className='col-lg-7 text-center position-relative mb-30'>
								<img src='/assets/imgs/page/homepage7/img-2.png' alt='psymate' />
								<div className='shape-1 box-image-4'>
									<img
										src='/assets/imgs/page/homepage7/chart.png'
										alt='psymate'
									/>
								</div>
