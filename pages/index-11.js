						...
						<div className='row'>
							<div className='col-xl-5 col-lg-5 mb-30'>
								...
								<h2 className='color-white mb-5'>
									...
									trusted the <br className='d-none d-lg-block' />
									world over
								</h2>
							</div>
							<div className='col-xl-7 col-lg-7 mb-30'>
								<p className='font-sm color-white mb-20'>
									Et quaerat deserunt et numquam voluptatem et laborum consectetur
									non consequatur temporibus ea repellat nihil vel consectetur
									dolores et rerum voluptas. Nam voluptas reiciendis non laborum
									perspiciatis eum omnis cumque ab impedit earum ex quos porro sit
									dolorem cupiditate ut ducimus autem.
								</p>
								<div className='row'>
									...
									<div className='card-offer card-offer-2 hover-up'>
										...
										<div className='card-info'>
											...
											<p className='font-sm color-grey-500 mb-15'>
												Est minima repellendus in dolor dolorum aut
												assumenda ullam et voluptates numquam qui aliquam
												perspiciatis ad neque ullam. Qui sequi porro in
												tempore nemo et itaque eligendi qui iusto saepe et
												suscipit sint et pariatur dolor.
											</p>
										</div>
					...
					<div className='container'>
						<div className='bg-brand-1 box-cover-video bd-rd0'>
							<div className='row align-items-center'>
								<div className='col-xl-6 col-lg-6 pr-mb-0'>
									<img
										className='d-block'
						...
						<div className='bg-brand-1 box-cover-video box-cover-video-convert bd-rd0'>
							<div className='row align-items-center'>
								...
								<div className='col-xl-6 col-lg-6 pl-mb-0'>
									<img
										className='d-block'
										src='assets/imgs/page/homepage4/img-video.png'
										alt='psymate'
									/>
								</div>
							</div>
						...
						<div className='row align-items-center'>
							<div className='col-lg-4 mb-30'>
								<div className='card-guide bg-4'>
									<div className='card-image'>
										<img
											src='assets/imgs/page/homepage7/payment.png'
											alt='psymate'
										/>
									</div>
									<div className='card-info'>
							...
							<div className='col-lg-4 mb-30'>
								<div className='card-guide bg-5'>
									<div className='card-image'>
										<img
											src='assets/imgs/page/homepage7/money.png'
											alt='psymate'
										/>
									</div>
									<div className='card-info'>
							...
							<div className='col-lg-4 mb-30'>
								<div className='card-guide bg-7'>
									<div className='card-image'>
										<img
											src='assets/imgs/page/homepage7/support.png'
											alt='psymate'
										/>
									</div>
									<div className='card-info'>
