				...
				<div className='section home12-logos'>
					<div className='container'>
						<ul className='lists-logo'>
							<li>
								<img src='assets/imgs/page/homepage12/placed.png' alt='psymate' />
							</li>
							<li>
								<img src='assets/imgs/page/homepage12/cuebiq.png' alt='psymate' />
							</li>
							<li>
								<img src='assets/imgs/page/homepage12/factual.png' alt='psymate' />
							</li>
							<li>
								<img src='assets/imgs/page/homepage12/placeiq.png' alt='psymate' />
							</li>
							<li>
								<img src='assets/imgs/page/homepage12/airmeet.png' alt='psymate' />
							</li>
							<li>
								<img src='assets/imgs/page/homepage12/spen.png' alt='psymate' />
							</li>
							<li>
								<img src='assets/imgs/page/homepage12/klippa.png' alt='psymate' />
							</li>
							<li>
								<img
									...
									<div className='col-lg-6'>
										<div className='box-cover-pd'>
											<div className='box-image-rd-30'>
												<img
													className='w-100'
													src='assets/imgs/page/homepage12/business.png'
													alt='psymate'
												/>
												<h4 className='color-brand-1 lbl-on-top'>
													PSYMATE Business Platform
												</h4>
											</div>
										</div>
									</div>
							...
							<div className='row align-items-center'>
								...
								<div className='col-lg-6 position-relative mb-30 box-right'>
									<div className='box-image-account'>
										<img
											className='d-block'
											src='assets/imgs/page/homepage12/account.png'
											alt='psymate'
										/>
									</div>
