					...
					<div className='box-banner-home9'>
						<div className='container position-relative'>
							<div className='row align-items-center'>
								<div className='col-lg-7 mb-30'>
									...
									<h2 className='color-brand-1 mb-15 mt-0'>
										Promotes your business <br className='d-none d-lg-block' />
										no matter what you do
									</h2>
									<p className='font-md color-grey-500 mb-20'>
										Collaborate, plan projects and manage resources with powerful features that{' '}
										<br className='d-none d-lg-block' />
										your whole team can use. The latest news, tips and advice to help you run your
										<br className='d-none d-lg-block' />
										business with less fuss.
									</p>
									<div className='mt-10'>
										<a
											className='btn btn-play btn-play-white font-sm-bold popup-youtube'
									...
									<div className='box-joined'>
										<div className='box-authors'>
											<span className='item-author'>
												<img src='/assets/imgs/page/homepage7/author1.png' alt='psymate' />
											</span>
											<span className='item-author'>
												<img src='/assets/imgs/page/homepage7/author2.png' alt='psymate' />
											</span>
											<span className='item-author'>
												<img src='/assets/imgs/page/homepage7/author3.png' alt='psymate' />
											</span>
											<span className='item-author'>
												<span className='text-num-author font-md-bold color-brand-1 bg-grey-60'>
													+2k
												</span>
											</span>
										</div>
							...
							<div className='box-image-banner-9'>
								<img src='/assets/imgs/page/homepage9/banner.png' alt='psymate' />
							</div>
							<div className='box-ticks'>
								<div className='row'>
									<div className='col-lg-4 mb-20'>
										<span className='item-tick color-brand-1 font-xl-bold'>
									...
									<div className='col-lg-4 mb-20'>
										<span className='item-tick color-brand-1 font-xl-bold'>
											Monthly flat-rate. Support 24/7
										</span>
									</div>
								</div>
							</div>
					...
					<div className='container'>
						<div className='text-center'>
							...
							<p className='color-grey-500 font-md'>
								Discover powerful features to boost your productivit. You are always welcome to
								visit our little den. Professional in teir
								<br className='d-none d-lg-block' />
								craft! All products were super amazing with strong attension to details, comps and
								overall vibe.
							</p>
						</div>
							...
							<div className='col-xl-6 col-lg-6 mb-30'>
								<div className='card-radius-32 bg-2'>
									<div className='card-info text-start'>
										...
										<p className='font-md color-grey-500 mb-20'>
											Manage your media channels professionally and efficiently. Real-time and
									...
									<div className='card-image mb-10'>
										<img src='/assets/imgs/page/homepage9/img.png' alt='psymate' />
									</div>
								</div>
							</div>
							<div className='col-xl-6 col-lg-6 mb-30'>
								<div className='card-radius-32 bg-11'>
									<div className='card-info text-start'>
										...
										<p className='font-md color-grey-500 mb-20'>
											Synchronize and automate all your business in the cloud. Save time and effort,
									...
									<div className='card-image image-automated'>
										<img
											className='d-block'
											src='/assets/imgs/page/homepage9/img2.png'
											alt='psymate'
										/>
									</div>
								</div>
										...
										<div className='col-lg-6'>
											<div className='box-cover-pd box-cover-pd-3 pt-30 pb-30 mb-30'>
												...
												<h2 className='color-brand-1 mt-10 mb-15'>
													Business can also <br className='d-none d-lg-block' />
													be simple
												</h2>
												<p className='font-md color-grey-400'>
													Access advanced order types including limit, market, stop limit and dollar
													cost averaging. Track your total asset holdings, values and equity over
													time. Monitor markets, manage your portfolio, and trade crypto on the go.
												</p>
												<div className='mt-40'>
												...
												<div className='mt-40 text-start'>
													<Link className='btn btn-brand-1 hover-up' href='/help'>
														Help Center{' '}
													</Link>
										...
										<div className='col-lg-6 text-center position-relative'>
											<div className='box-circle-image'>
												<img
													...
													src='/assets/imgs/page/homepage9/img3.png'
													alt='psymate'
												/>
												<div className='shape-1 box-image-4'>
													<img src='/assets/imgs/page/homepage9/testimonial.png' alt='psymate' />
												</div>
						...
						<div className='text-center mt-25 mb-65'>
							<div className='box-social-media'>
								<ul className='tabs-plan change-media' role='tablist'>
									<li>
										{' '}
										<a className={social === 1 ? 'active' : ''} onClick={() => handleSocial(1)}>
											Personal
										</a>
									</li>
									<li>
										{' '}
										<a className={social === 2 ? 'active' : ''} onClick={() => handleSocial(2)}>
											Enterprise
										</a>
									</li>
								</ul>
								...
								<>
										...
										<div className='card-offer-style-2'>
											<div className='card-offer hover-up'>
												<div className='card-image'>
													<img src='assets/imgs/page/homepage1/cross2.png' alt='psymate' />
												</div>
												<div className='card-info'>
													<h4 className='color-brand-1 mb-15'>Cross-Platform</h4>
													<p className='font-md color-grey-500 mb-15'>
														Discover powerful features to boost your productivit. You are always
														welcome to visit our little den. Professional in teir craft! All
														products were super amazing with strong attension to details, comps and
														overall vibe.
													</p>
									...
									<div className='col-lg-4 col-md-6 social-media enterprise'>
										<div className='card-offer-style-2 bg-5'>
											<div className='card-offer hover-up'>
												<div className='card-image'>
													<img src='assets/imgs/page/homepage1/cross.png' alt='psymate' />
												</div>
												<div className='card-info'>
									...
									<div className='col-lg-4 col-md-6 social-media personal'>
										<div className='card-offer-style-2 bg-2'>
											<div className='card-offer hover-up'>
												<div className='card-image'>
													<img src='assets/imgs/page/homepage2/identity.png' alt='psymate' />
												</div>
												<div className='card-info'>
									...
									<div className='col-lg-4 col-md-6 social-media enterprise'>
										<div className='card-offer-style-2 bg-1'>
											<div className='card-offer hover-up'>
												<div className='card-image'>
													<img src='assets/imgs/page/homepage1/cross4.png' alt='psymate' />
												</div>
												<div className='card-info'>
								...
								<>
									...
									<div className='col-lg-4 col-md-6 social-media personal'>
										<div className='card-offer-style-2 bg-7'>
											<div className='card-offer hover-up'>
												<div className='card-image'>
													<img src='assets/imgs/page/homepage1/cross5.png' alt='psymate' />
												</div>
												<div className='card-info'>
									...
									<div className='col-lg-4 col-md-6 social-media enterprise'>
										<div className='card-offer-style-2 bg-4'>
											<div className='card-offer hover-up'>
												<div className='card-image'>
													<img src='assets/imgs/page/homepage2/creation.png' alt='psymate' />
												</div>
												<div className='card-info'>
					...
					<div className='container'>
						<div className='text-center'>
							...
							<p className='font-lg color-grey-500'>
								...
								<br className='d-none d-lg-block' />
								Join them. Elevate your testing.
							</p>
						</div>
						<div className='mt-30'>
							...
							<div className='row align-items-center'>
								<div className='col-lg-7'>
									...
									<h1 className='color-brand-1 mb-20 mt-10'>
										Start for free <br className='d-none d-lg-block' />
										Pay as you Grow
									</h1>
									<div className='row'>
										<div className='col-lg-10'>
											<p className='font-md color-grey-500'>
												Collaborate, plan projects and manage resources with powerful features that
												your whole team can use. The latest news, tips and advice to help you run
									...
									<div className='box-button mt-20'>
										<Link className='btn-app mb-15 hover-up' href='#'>
											<img src='/assets/imgs/template/appstore-btn.png' alt='psymate' />
										</Link>
										<Link className='btn-app mb-15 hover-up' href='#'>
											<img src='/assets/imgs/template/google-play-btn.png' alt='psymate' />
										</Link>
									...
									<div className='box-signup'>
										...
										<div className='form-group mb-25'>
											<Link className='btn btn-border btn-full signin-google' href='#'>
												<img src='/assets/imgs/page/homepage4/google.png' alt='psymate' />
												Sign in with Google
											</Link>
										</div>
										<div className='text-already text-center'>
											<span className='font-xs color-grey-400'>Already have an account? </span>
											<Link className='color-brand-1 font-xs' href='#'>
												Sign in
											</Link>
				...
				<section className='section pt-80'>
					<div className='container'>
						...
						<div className='row mt-50 mb-50'>
							<div className='col-xl-12 col-lg-12 position-relative'>{/* <Accordion2 /> */}</div>
						</div>
					</div>
				</section>
				<section className='section mt-40 pt-50 pb-15 bg-grey-80'>
					<div className='container'>
						<div className='box-swiper'>
							<div className='swiper-container swiper-group-3'>{/* <Knowledgebase /> */}</div>
						</div>
					</div>
				</section>
				<div className='mt-50' />
						...
						<div className='row mt-55'>
								...
								<div className='card-blog-grid card-blog-grid-2 hover-up'>
									<div className='card-image'>
										<Link href='/blog-detail'>
											<img src='/assets/imgs/page/homepage2/news1.png' alt='psymate' />
										</Link>
									</div>
									<div className='card-info'>
										<Link href='/blog-detail'>
										...
										<p className='font-sm color-grey-500 mt-20'>
											Fusce dictum ullamcorper dui, id dignissim arcu volutpat vitae. Aenean mattis
											vestibulum odio eu facilisis. Aenean quam arcu, blandit at aliquet sit amet,
											convallis nec risus.
										</p>
							...
							<div className='col-xl-3 col-lg-6 col-md-6'>
								<div className='card-blog-grid card-blog-grid-2 hover-up'>
									<div className='card-image'>
										<Link href='/blog-detail'>
											<img src='/assets/imgs/page/homepage2/news2.png' alt='psymate' />
										</Link>
									</div>
									<div className='card-info'>
										<Link href='/blog-detail'>
							...
							<div className='col-xl-3 col-lg-6 col-md-6'>
								<div className='card-blog-grid card-blog-grid-2 hover-up'>
									<div className='card-image'>
										<Link href='/blog-detail'>
											<img src='/assets/imgs/page/homepage1/news2.png' alt='psymate' />
										</Link>
									</div>
									<div className='card-info'>
										<Link href='/blog-detail'>
							...
							<div className='col-xl-3 col-lg-6 col-md-6'>
								<div className='card-blog-grid card-blog-grid-2 hover-up'>
									<div className='card-image'>
										<Link href='/blog-detail'>
											<img src='/assets/imgs/page/homepage2/news3.png' alt='psymate' />
										</Link>
									</div>
									<div className='card-info'>
										<Link href='/blog-detail'>
