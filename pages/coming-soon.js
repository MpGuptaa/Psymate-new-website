					...
					<div className='container'>
						<div className='row align-items-center'>
							<div className='col-lg-7 mb-40'>
								...
								<div className='mt-45'>
									<a className='icon-socials icon-facebook mr-15' href='#' />
									<a className='icon-socials icon-instagram mr-15' href='#' />
									<a className='icon-socials icon-twitter mr-15' href='#' />
									<a className='icon-socials icon-linkedin mr-15' href='#' />
									<a className='icon-socials icon-youtube' href='#' />
								</div>
							</div>
