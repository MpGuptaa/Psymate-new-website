				...
				<section className='section mt-90'>
					<div className='container'>
						...
						<div className='box-video mt-70'>
							{' '}
							<img src='assets/imgs/page/career/img-video.png' alt='psymate' />
							<div className='image-1 shape-1'>
								<img src='assets/imgs/page/career/certify.png' alt='psymate' />
							</div>
						</div>
					</div>
				</section>
						...
						<div className='row'>
							<div className='col-lg-12 text-center'>
								...
								<p className='font-lg color-gray-500'>
									We're lively, not corporate. We have the energy and boldness of
									a startup and <br className='d-none d-lg-block' />
								...
								<div className='card-small card-small-2'>
									...
									<div className='card-info'>
										...
										<p className='font-xs color-grey-500'>
											...
											regions, offices and screens. You will receive support
											from your teammates anytime and anywhere.
										</p>
									</div>
								</div>
							</div>
								...
								<div className='card-small card-small-2'>
									...
									<div className='card-info'>
										...
										<p className='font-xs color-grey-500'>
											...
											equitable access to opportunity for everyone. No matter
											where you come from
										</p>
									</div>
								</div>
							...
							<div className='col-lg-3 col-md-6 col-sm-6'>
								<div className='card-small card-small-2'>
									...
									<div className='card-info'>
										...
										<p className='font-xs color-grey-500'>
											We believe in your freedom to work when and how you work
											best, to help us all thrive. Only freedom and
											independent work can bring out the best in you.
										</p>
									</div>
								</div>
							</div>
							<div className='col-lg-3 col-md-6 col-sm-6'>
								<div className='card-small card-small-2'>
									...
									<div className='card-info'>
										...
										<p className='font-xs color-grey-500'>
											Knowing that there is real value to be gained from
											helping people to simplify whatever it is that they do
											and bring.
										</p>
									</div>
								</div>
								...
								<div className='card-offer card-we-do hover-up'>
									...
									<div className='card-info'>
										...
										<p className='font-md color-grey-500 mb-5'>
											Seamless importing and round-tripping of Microsoft
											Project plans, Excel files &amp; CSV files.
										</p>
							...
							<div className='col-lg-6'>
								<div className='card-offer card-we-do hover-up'>
									...
									<div className='card-info'>
										...
										<p className='font-md color-grey-500 mb-5'>
											No lag time, no lost effort when prpsymateties change,
											no email black hole. As team collaboration improves
										</p>
										<div className='box-button-offer'>
											<a className='btn btn-default font-sm-bold pl-0 color-brand-1'>
												Learn More
