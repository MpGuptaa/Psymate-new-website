						...
						<div className='col-xxl-7 col-xl-5 col-lg-6 pr-0'>
							<div className='d-none d-xxl-block pl-70'>
								<img
									...
									src='assets/imgs/page/service/banner.png'
									alt='psymate'
								/>
							</div>
						</div>
									...
									<div className='box-business-service'>
										<div className='box-number-1 shape-2'>
											<div className='cardNumber bg-white'>
												<h3>25k+</h3>
												<p className='font-xs color-brand-1'>
													Happy Clients
												</p>
											</div>
										</div>
										<div className='box-image-1 shape-3'>
											{' '}
											<img
												src='assets/imgs/page/service/img1.png'
												alt='psymate'
											/>
										</div>
										<div className='box-image-2 shape-2'>
											{' '}
											<img
												src='assets/imgs/page/service/img2.png'
												alt='psymate'
											/>
										</div>
										<div className='box-image-3 shape-1'>
											{' '}
											<img
												src='assets/imgs/page/service/img4.png'
												alt='psymate'
											/>
											<div className='cardNumber bg-white'>
