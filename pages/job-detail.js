									...
									<div className='box-detail-content'>
										<div className='row align-items-center'>
											<div className='col-lg-8 col-md-8 col-sm-12 col-12 mb-30'>
												<h3 className='color-brand-1 mb-10 mt-0'>
													Business Development Manager and Financial
													Services
												</h3>
											...
											<div className='col-lg-4 col-md-4 col-sm-12 col-12 text-start text-md-end mb-30'>
												{' '}
												<Link
													className='btn btn-brand-1 btn-apply'
													href='#'>
													<svg
										...
										<ul>
											...
											<li>
												...
												and prpsymatetize tasks and goals independently
											</li>
											<li>
												History of impacting shipping products with your
												work
											</li>
											<li>
										...
										<ul>
											<li>
												Annual bonus and holidays, social welfare, and
												health checks.
											</li>
											<li>
										...
										<div className='box-info-bottom'>
											<div className='row align-items-center'>
												...
												<div className='col-lg-6 col-md-6 col-sm-7 col-12 text-start text-sm-end mb-30'>
													...
													<Link
														className='btn btn-tag ml-10 mb-10'
														href='#'>
														Digital
													</Link>
													<Link
