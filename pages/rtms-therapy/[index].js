									...
									<div className='row align-items-start'>
										...
										<div className='col-xl-8 col-lg-12 col-md-7'>
											<p>
												...
												exercitationem ut ipsam velit. Ut nihil dolorem eos
												nemo temporibus ut sunt aspernatur! Est voluptatem
												officiis id harum facere aut minus mollitia in
												commodi sint sed placeat quia cum ipsum quis. Et
												quia reiciendis in ducimus fugit qui dolores
												aspernatur aut quis error et aspernatur pariatur? Ut
												dolor quas cum beatae explicabo ex velit voluptatum
												ut temporibus illum. Vel voluptate galisum qui
												cupiditate nobis a perferendis sunt ut deserunt
												omnis eum dolor aperiam? Et voluptatem velit et
												voluptatem cumque vel voluptatem nemo ex ipsum
												voluptatem non distinctio rerum ut neque ipsum non
												aspernatur corporis. Et perspiciatis laboriosam a
												sint iste et quis minus aut aspernatur voluptatibus
												aut velit omnis aut excepturi sunt ut sapiente
												optio! Non nihil facilis ut molestiae rerum aut
												aliquam aperiam et atque Quis qui delectus illum cum
												atque officiis 33 cumque error. Ut vero provident
												eum minus pariatur ab consequuntur galisum rem
												internos ipsum. Qui labore libero qui vero ipsum ut
												voluptas consequatur in nihil similique aut
												exercitationem adipisci sed totam quia. Est cumque
												galisum ut nihil eveniet et consequatur quae qui
												enim earum ad voluptatem modi in explicabo
												recusandae. Et autem sint est placeat veritatis et
												animi facilis est beatae assumenda non recusandae
												fugiat.
											</p>
										</div>
									</div>
							...
							<div className='col-lg-4 col-md-6 mb-30 item-article featured'>
								<div className='card-blog-grid card-blog-grid-3 hover-up'>
									...
									<div className='card-info'>
										<Link href='/blog-detail'>
											<h4 className='color-brand-1'>
												7 Copywriting Strategies the Great Copywriters Wish
												You Knew
											</h4>
										</Link>
							...
							<div className='col-lg-4 col-md-6 mb-30 item-article other'>
								<div className='card-blog-grid card-blog-grid-3 hover-up'>
									...
									<div className='card-info'>
										<Link href='/blog-detail'>
											<h4 className='color-brand-1'>
												The Betty Crocker Secret to an Email Marketing
												Strategy People Enjoy
											</h4>
										</Link>
										<div className='mb-25 mt-10'>
											<span className='font-xs color-grey-500'>
...
export default rtmsDescription;
